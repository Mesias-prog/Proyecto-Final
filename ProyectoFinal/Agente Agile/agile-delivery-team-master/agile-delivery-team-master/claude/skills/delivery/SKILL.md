...
{
  "epics": [
    { "id": "E-01", "title": "Agendamiento de citas y recepción", "value": "...", "priority": 1, "origin": ["mvp:agendamiento-whatsapp"] }
  ],
  "stories": [
    {
      "id": "US-01",
      "epic": "E-01",
      "as_a": "cliente",
      "want": "agendar una cita de revisión para mi vehículo",
      "so_that": "asegurar que haya una bahía y un mecánico disponible sin esperas",
      "acceptance_criteria": [
        "Dado un horario con bahías disponibles, cuando el cliente solicita agendar, entonces la cita queda registrada y recibe confirmación."
      ],
      "estimate": 3,
      "dependencies": [],
      "open_questions": [],
      "priority": 1,
      "origin": ["us:agendamiento-whatsapp"]
    }
  ]
}
```
